  ...
  def student_homework_labels
    {
      ...
      watchMaterial: t('app.student_portal.materials.watch'),
      downloadMaterial: t('app.student_portal.materials.download'),
      openLink: t('app.student_portal.materials.open_link'),
